...
#define POP3WIRE_FEATURE_COUNT            (32)  // == FEATURE_ENUM_MAX_SIZE - bump when adding a _FEATURE
...
static_assert(sizeof(ServerLevelPacket) == 232, "ServerLevelPacket wire size"); // 2026-07-17: POP3WIRE_FEATURE_COUNT 31->32 (CAP_MAX_MANA) - FeatureSettings[32] grows the array 1 byte but shrinks the pre-Seed pad 3->2, so Seed still lands at offset 132: total unchanged at 232
