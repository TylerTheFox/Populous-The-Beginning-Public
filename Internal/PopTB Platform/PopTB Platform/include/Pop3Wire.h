...
#define POP3WIRE_FEATURE_COUNT            (31)  // == FEATURE_ENUM_MAX_SIZE - bump when adding a _FEATURE
...
static_assert(sizeof(ServerLevelPacket) == 232, "ServerLevelPacket wire size"); // 2026-07-17: POP3WIRE_FEATURE_COUNT 30->31 (BOAT_CLUSTER_SPREAD) - FeatureSettings[31] ends the array at odd offset, re-introducing a 3-byte pad before the 4-aligned Seed field: +4 total (228->232)
